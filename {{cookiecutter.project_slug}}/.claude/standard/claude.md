# Standard Claude Development Guidelines

> **Source**: ByronWilliamsCPA/.claude repository
> **Version**: 1.0.0
> **Scope**: Universal development standards for all projects using this template
>
> This file contains baseline standards. Project-specific configurations are in the root `CLAUDE.md`.
...
# Key validation (if using signed commits)
...
*This baseline is automatically included in projects generated from the cookiecutter-python-template.*
*For project-specific configurations, see the root `CLAUDE.md` file.*
