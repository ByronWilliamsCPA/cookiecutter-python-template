...
>
> **Generated From**: cookiecutter-python-template v{{cookiecutter.version}}
...
- `{{cookiecutter.project_slug}}/path/to/file.ext`
...
- Template version used (`{{cookiecutter.version}}`)
