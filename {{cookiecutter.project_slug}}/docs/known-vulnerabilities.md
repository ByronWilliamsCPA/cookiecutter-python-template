...
For the template to add new entries, see [known-vulnerabilities-template.md](known-vulnerabilities-template.md).
...
|-------------|----------|-------|
| {{ cookiecutter.copyright_year }}-MM-DD | {{ cookiecutter.author_name }} | Initial creation. |
