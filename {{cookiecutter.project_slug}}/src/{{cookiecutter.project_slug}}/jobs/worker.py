...
async def process_file_upload(
    ...
    try:
        ...
        logger.exception("file_processing_failed", file_id=file_id, error=str(e))
        raise
...
async def startup(_ctx: dict[str, Any]) -> None:
    ...
    Args:
        _ctx: ARQ context (store initialization results here)
    """
...
async def shutdown(_ctx: dict[str, Any]) -> None:
    ...
    Args:
        _ctx: ARQ context (contains initialized resources to cleanup)
    """
...
# Run worker:
# celery -A {{ cookiecutter.project_slug }}.jobs.celery_worker worker --loglevel=info

# Run beat scheduler:
# celery -A {{ cookiecutter.project_slug }}.jobs.celery_worker beat --loglevel=info
"""
