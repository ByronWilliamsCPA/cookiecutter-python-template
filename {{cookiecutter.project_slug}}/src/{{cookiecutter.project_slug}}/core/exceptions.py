"""Centralized exception hierarchy for {{ cookiecutter.project_name }}.
...
def _attach_optional_details(
    ...
    Args:
        details (dict[str, Any]): Existing details dict (may be empty, will
            be mutated).
        **fields (Any): Optional fields to add; None values are skipped.

    Returns:
        dict[str, Any]: The details dict with non-None fields added (modified
...
class APIErrorContext:
    ...
    Attributes:
        ...
        retry_after (int | None): Seconds to wait before retrying (for
            rate limits).
...
class APIError(ExternalServiceError):
    ...
    Args:
        ...
        retry_after (int | None): Seconds to wait before retrying (for
            rate limits).
        context (APIErrorContext | None): Optional grouped fields; overrides
            individual kwargs when provided.
        details (dict[str, Any] | None): Additional context.
        error_code (str | None): Machine-readable error code.
...
class FinancialCalculationError(BusinessLogicError):
    """Financial calculation errors.

    Raised when financial calculations fail or produce invalid results.

    Args:
        message (str): Description of the calculation error.
        operation (str | None): The financial operation that failed.
        details (dict[str, Any] | None): Additional context.
        error_code (str | None): Machine-readable error code.

    Example:
        >>> raise FinancialCalculationError(
        ...     "Division by zero in tax calculation",
        ...     operation="tax_rate_calculation",
        ... )
    """
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            details=details,
            error_code=error_code or "FINANCIAL_CALCULATION_ERROR",
        )
