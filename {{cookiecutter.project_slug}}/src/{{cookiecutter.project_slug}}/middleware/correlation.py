...
Integration with Logging:
    from {{ cookiecutter.project_slug }}.middleware.correlation import correlation_context_processor
...
def get_correlation_id() -> str | None:
    ...
    Example:
        >>> from {{ cookiecutter.project_slug }}.middleware.correlation import get_correlation_id
        >>> correlation_id = get_correlation_id()
...
def correlation_context_processor(
    ...
    Args:
        _logger (WrappedLogger): The wrapped logger instance.
...
class CorrelationMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(
        ...
        Args:
            ...
            call_next (RequestResponseEndpoint): The next middleware or route
                handler.
